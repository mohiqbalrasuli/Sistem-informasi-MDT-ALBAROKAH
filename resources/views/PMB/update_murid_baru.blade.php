...
@section('title', 'Update Data Murid Baru')
@section('header', 'Update Data Murid Baru')
@section('content')
                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                ...
                                <li class="breadcrumb-item"><a href="/data-murid-baru">Murid Baru</a>
                                </li>
                                <li class="breadcrumb-item text-muted active" aria-current="page">Update Data Murid Baru</li>
                            </ol>
                        </nav>
                    </div>
                </div>
